flyingon.renderer('Highlight', function (base) {
    ...
    this.theme = function (control, view, value) {
        ...
        if (!styles[value])
        {
            flyingon.link(flyingon.require.path('flyingon-ui/web/third/highlight/styles/' + value + '.css'));
        }
    };
    ...
    this.code = function (control, view, value) {
        ...
        else
        {
            ...
            flyingon.script(flyingon.require.path('flyingon-ui/web/third/highlight/highlight.js'), init);
        }
    };
